...
Read through the setup instructions from the Django [Models](https://git.generalassemb.ly/sf-wdi-48/django-models) and [Views and Templates](https://git.generalassemb.ly/sf-wdi-48/django-views-and-templates)
